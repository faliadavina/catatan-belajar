        ...
        <div className="flex items-center justify-between mt-4">
          ...
          <div>
            ...
            <Button
              ...
              disabled={isLoading || !isi_catatan.trim()}
            >
            {isLoading ? (
                <div className="flex items-center">
                    <svg aria-hidden="true" className="inline w-5 h-5 mr-3 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600 dark:fill-gray-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
