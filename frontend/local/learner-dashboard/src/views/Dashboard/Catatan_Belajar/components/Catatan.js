...
import { Flex, Spacer, Text, useColorModeValue, Input, InputGroup, InputRightElement, Grid, GridItem } from "@chakra-ui/react";
...
const Catatan = () => {
    ...
    return (
        <Flex direction="column" padding="20px">
            <Text as="h1" fontSize="3xl" fontWeight="bold" mb="5" color={textColor}>
                Catatan Belajar
            </Text>
            ...
            <Flex position="relative">
                    <NotepadPopup isOpen={isModalOpen} onClose={handleCloseModal} style={{ position: "absolute", zIndex: 999999 }} />
                </Flex>
                <Spacer />
                <SearchBar />
            </Flex>
                        ...
                        <GridItem key={catatan.id_catatan} colSpan={1}>
                            <Card position="relative" overflowX={{ sm: "scroll", xl: "hidden" }} my={4}>
                                ...
                                <HStack spacing="4px" mt={5} pb=".5rem">
                                    <Image src="https://cdn.icon-icons.com/icons2/2468/PNG/512/user_icon_149329.png" borderRadius="full" boxSize="30px" marginRight="5px" />
